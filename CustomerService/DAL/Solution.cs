...
namespace CustomerService.DAL
{
	...
	public partial class Solution
	{
		...
		public bool Exists(Guid GUID)
		{
			...
			int result= DbHelperSQL.RunProcedure("T_Solution_Exists",parameters,out rowsAffected);
			if(result==1)
			{
				return true;
			}
		...
		public bool Add(CustomerService.Model.Solution model)
		{
            ...
            DbHelperSQL.RunProcedure("T_Solution_ADD", parameters, out rowsAffected);
            if (rowsAffected > 0)
            {
                return true;
            }
		...
		public bool Delete(Guid GUID)
		{
			...
			DbHelperSQL.RunProcedure("T_Solution_Delete",parameters,out rowsAffected);
			if (rowsAffected > 0)
			{
				return true;
			}
		...
		public bool DeleteList(string GUIDlist )
		{
			...
			strSql.Append("delete from T_Solution ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select GUID,sDescribe,solution,createDate ");
			strSql.Append(" FROM T_Solution ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" GUID,sDescribe,solution,createDate ");
			strSql.Append(" FROM T_Solution ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
